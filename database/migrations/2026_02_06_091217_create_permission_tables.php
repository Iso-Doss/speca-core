...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $pivotCategory = $columnNames['permission_category_pivot_key'] ?? 'permission_category_id';
        ...
        if (! Schema::hasTable($tableNames['permission_categories'])) {
            Schema::create($tableNames['permission_categories'], static function (Blueprint $table) {
                ...
                $table->string('label')->unique();       // For MyISAM use string('name', 225); // (or 166 for InnoDB with Redundant/Compact row format)
        ...
        if (! Schema::hasTable($tableNames['category_has_permissions'])) {
            Schema::create($tableNames['category_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotPermission, $pivotCategory) {
                ...
                $table->foreign($pivotCategory)
                    ->references('id') // categories permission id
                    ->on($tableNames['permission_categories'])
                    ->onDelete('cascade');

                $table->primary([$pivotPermission, $pivotCategory], 'category_has_permissions_permission_id_permission_category_id_primary');
            });
        }
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists($tableNames['category_has_permissions']);
        Schema::dropIfExists($tableNames['role_has_permissions']);
        Schema::dropIfExists($tableNames['model_has_roles']);
        Schema::dropIfExists($tableNames['model_has_permissions']);
        Schema::dropIfExists($tableNames['roles']);
        Schema::dropIfExists($tableNames['permissions']);
        Schema::dropIfExists($tableNames['permission_categories']);
    }
};
